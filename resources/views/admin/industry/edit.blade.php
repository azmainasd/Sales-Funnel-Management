      ...
      <div class="row justify-content-center">
        <div class="col-md-8 ">
         <div class="card card-primary"> 
              <!-- form start -->
              {!! Form::open(array('route' => ['industry.update',$industry->id], 'method' => 'POST')) !!}
                @csrf
                @method('PUT')
                <div class="card-body">
                    @if(count($errors) > 0)
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-10 custom-control custom-switch custom-switch-off-danger custom-switch-on-success ">
                        {{ Form::checkbox('active', 1, $industry->active,[$industry->active == 1,'class' => 'custom-control-input', 'id' => 'customSwitch3']) }} 
                        <label class="custom-control-label ml-2" for="customSwitch3">Active</label>
                      </div>                  
                    </div>
                    <div class="text-center">
                      <a class="btn btn-outline-success" href="{{ route('industry.index')}}"> Back</a>
